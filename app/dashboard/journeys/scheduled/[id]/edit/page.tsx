...
import { ArrowLeft, Save, Calendar, Eye, MapPin, Lock, Camera, Shield, User, Clock } from "lucide-react";
...
export default function EditScheduledPage() {
          ...
          <div className="bg-white rounded-lg shadow-sm p-8 text-center">
            <div className="flex flex-col items-center space-y-4">
              ...
              <p className="text-gray-600 max-w-md">
                To edit your scheduled journey, please connect your wallet using the button above.
              </p>
              <ConnectButtonCustom />
            </div>
          </div>
    ...
    try {
      ...
      if (response.ok) {
        ...
        const newFormData = {
          ...
          shareType: journeyData.shareType || "scheduled"
        };
  ...
  const handleReschedule = async () => {
    ...
    try {
      ...
      console.error("Error rescheduling journey:", error);
    } finally {
      setSaving(false);
    }
  };
  ...
  const isOverdue = journey.scheduledAt && new Date(journey.scheduledAt) < new Date();
      ...
      <div className="pt-16">
              ...
              <div>
                <div className="flex items-center space-x-3 mb-2">
                  ...
                  >
                    ...
                    <span className="hidden sm:inline">Back to Scheduled</span>
                ...
                <p className="text-base sm:text-lg text-gray-600 mt-2">
                  Modify your journey details before it goes live
                </p>
                {isOverdue && (
                  <div className="mt-2 p-3 bg-red-50 border border-red-200 rounded-lg">
                    <p className="text-red-700 text-sm">
                      ⚠️ This journey is overdue for publishing. Consider publishing now or rescheduling.
                    </p>
                  </div>
                )}
              </div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 lg:gap-8">
          ...
          <div className="xl:col-span-2 space-y-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent text-gray-900 bg-white text-sm sm:text-base"
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="block w-full text-xs sm:text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-xs file:sm:text-sm file:font-semibold file:bg-orange-50 file:text-orange-700 hover:file:bg-orange-100"
                  />
            ...
            {/* Scheduling */}
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
              <h2 className="text-lg sm:text-xl font-semibold text-gray-900 mb-4">Schedule Settings</h2>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-gray-500 mt-1">
                    Change the scheduled publication time or clear to move back to draft
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  disabled={saving}
                  className="w-full flex items-center justify-center px-4 py-2.5 sm:py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 disabled:opacity-50 text-sm sm:text-base"
                >
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center px-4 py-2.5 sm:py-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700 disabled:opacity-50 text-sm sm:text-base"
                >
                ...
                <button
                  ...
                  disabled={saving}
                  className="w-full flex items-center justify-center px-4 py-2.5 sm:py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 disabled:opacity-50 text-sm sm:text-base"
                >
                  Move to Draft
                </button>
              </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
              ...
              <div className="space-y-3 text-xs sm:text-sm">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-medium">
                    {journey.scheduledAt ? new Date(journey.scheduledAt).toLocaleDateString() : 'Not set'}
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-500">Images:</span>
                  <span className="font-medium">{existingImages.length + selectedImages.length}</span>
                </div>
              </div>
            </div>
          </div>
